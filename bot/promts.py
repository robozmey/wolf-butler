...
/new_reminder_with_time HH:MM reminder_text		- 		создать новое напоминание со временем когда напоминать
/get_reminders		-		получить список напоминаний
/get_reminders_by_time reminder_time		-		получить список напоминаний на определеное время
